   ...
   <form action="index.do" method="post">
      ...
      <table width="70%" border="0" cellpadding="4" cellspacing="4">
         ...
         <c:forEach items="${list }" var="list">
               <td class="hover" width="17%" height="250px" bgColor="#DDDDDD"><a href="productDetail.do?product_id=${list.product_id }"><br>${list.product_name }<br><br><img src="img/product/${list.main_img }" class="item_img"><br>${list.category }<br>${list.quality }<br>\ ${list.price }</a></td>
